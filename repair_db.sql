...
-- Drops corrupted database and recreates all tables from scratch
-- ============================================================

DROP DATABASE IF EXISTS tqseet_db;
CREATE DATABASE tqseet_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE tqseet_db;
...
-- 3. SETTLEMENTS (must come before orders for FK)
...
-- 8. FINANCIAL PROFILES (Credit Scoring)
